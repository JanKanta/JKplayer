...
The folder name is what exrplayer.paths.platform_tag() returns under the Nuke
...
Nothing is shipped in here. On the first GUI launch EXRplayer offers to fetch
what this Nuke needs; the same is available later under
EXRplayer > Install dependencies. To do it by hand, run the Nuke you want to
support:
